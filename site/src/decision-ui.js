...
function mapStep() {
  ...
  return `<div class="stack">
    <div><span class="eyebrow">Step 2 · What matters</span><h2 id="decision-step-heading" tabindex="-1">What matters?</h2><p class="muted">Name the goals and requirements that should guide this decision. Possible futures remain in Step 4.</p></div>
